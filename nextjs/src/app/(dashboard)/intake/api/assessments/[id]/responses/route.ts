// Intake Assessment Responses API — POST upload a recording and save its
// response record for an intake assessment.
// Follows the same API-route pattern as resume-builder / audio-text-assessment.
import { NextResponse, type NextRequest } from 'next/server'
import { createSSRClient } from '@/lib/supabase/server'

type Params = { params: Promise<{ id: string }> }

/** POST /api/assessments/[id]/responses — upload audio + save response */
